...
public class EjemploInventario : MonoBehaviour
{
    void Start()
    {
        ...
        Armadura corazaDelGuardian = new Armadura("Coraza del Guardi?n", "Una coraza impenetrable que ha protegido a generaciones", Rareza.Legendario, null, 150, 50, 30, 50, 15, 100, ParteArmadura.Central, true, true);
        ...
        Armadura yelmoDeSabiduria = new Armadura("Yelmo de Sabidur?a", "Un yelmo antiguo que mejora la percepci?n y el juicio del portador", Rareza.Epico, null, 90, 40, 25, 30, 20, 85, ParteArmadura.Cabeza, true, true);
        ...
        Consumible pocionCurativa = new Consumible("Poci?n Curativa", "Una poci?n m?gica que restaura la salud", Rareza.Raro, null, 10, 5, 50, "Restaura 50 de salud", 0, 100, true);
        ...
        Artefacto amuletoVida = new Artefacto("Amuleto de la Vida", "Un antiguo amuleto que otorga vitalidad adicional", Rareza.Legendario, null, 100, 50, 0, "Aumenta la salud m?xima", true);
        Artefacto cristalSabiduria = new Artefacto("Cristal de Sabidur?a", "Un cristal m?stico que ilumina la mente del portador", Rareza.Epico, null, 80, 40, 10, "Mejora la regeneraci?n de man?", true);
        Artefacto piedraEterna = new Artefacto("Piedra Eterna", "Una piedra m?gica que es fuente de energ?a inagotable", Rareza.Raro, null, 60, 30, 20, "Reduce el tiempo de recarga de habilidades", true);
